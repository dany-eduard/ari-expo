        ...
        <View className="max-w-md mx-auto w-full flex-1 gap-8">
          ...
          <View className="space-y-4">
            ...
            >
              {isDownloading && downloadProgress ? (
                <View className="w-full p-4 bg-slate-50 dark:bg-slate-800/50">
                  <View className="flex-row items-center justify-between mb-2">
                    <Text className="text-sm font-semibold text-text-main-light dark:text-text-main-dark">Descargando registros...</Text>
                    <Text className="text-sm font-bold text-blue-600 dark:text-blue-400">{downloadProgress.percent}%</Text>
                  </View>
                  <View className="h-2 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                    <View className="h-full bg-blue-500 rounded-full" style={{ width: `${downloadProgress.percent}%` }} />
                  </View>
                  <Text className="text-xs text-slate-500 dark:text-slate-400 mt-1">{downloadProgress.currentFile}</Text>
                </View>
              ) : (
                <TouchableOpacity
                  activeOpacity={0.7}
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => router.push("/settings/monthly-summary")}
                className="w-full flex-row items-center justify-between p-5 border-b border-border-input-light dark:border-border-input-dark active:bg-slate-50 dark:active:bg-slate-800/50"
              >
                <View className="flex-row items-center gap-4">
                  <View className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-900/30 items-center justify-center">
              ...
              >
                <View className="flex-row items-center gap-4">
                  ...
                  <Text className="font-semibold text-[16px] text-text-main-light dark:text-text-main-dark">
                    Sincronizar estado de publicadores
                  </Text>
          ...
          <View className="mt-auto gap-8">
            ...
            <View className="pt-4">
              <TouchableOpacity
                ...
                onPress={signOut}
                style={styles.iosShadow}
                className="w-full flex-row items-center justify-center gap-2 p-4 bg-card-light dark:bg-card-dark rounded-2xl border border-red-50 dark:border-red-950/20 active:scale-[0.98]"
              >
