...
export default function RegularPioneersActivityScreen() {
  ...
  const fetchActivity = useCallback(async (isRefresh = false) => {
    try {
      ...
      setError(null);
      const response = await reportService.getRegularPioneersActivity();
      setData(response);
    } catch (err: any) {
    ...
    <ThemedView className="flex-1">
        ...
        <View className="flex-row items-center px-4 pb-4 gap-4">
          ...
          <View className="flex-1">
            ...
            <Text className="text-xs text-text-secondary-light dark:text-text-secondary-dark">
              Precursores Regulares • Año de servicio actual
            </Text>
          </View>
        </View>
      </View>
      ...
      >
        {isLoading ? (
          ...
          <NoData title="No hay precursores regulares registrados" icon="group-off" />
        ) : (
                ...
                >
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-xs text-text-secondary-light dark:text-text-secondary-dark mt-0.5">
                      Ningún precursor regular supera las 560 horas acumuladas en este momento.
                    </Text>
                  </View>
                </View>
              )}
