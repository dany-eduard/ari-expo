 ...
 */
const InputField: React.FC<InputFieldProps> = ({ label, type = "text", placeholder, value, onChange, icon, showToggle }) => {
  ...
  return (
    <View className="flex flex-col gap-2">
      ...
      <View className="relative w-full">
        <TextInput
          className={`w-full rounded-xl border border-border-input bg-surface-input h-14 pl-4 ${
            icon || showToggle ? "pr-12" : "pr-4"
          } text-base text-text-main focus:border-primary transition-all`}
